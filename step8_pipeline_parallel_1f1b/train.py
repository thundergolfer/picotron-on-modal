...
def all_reduce_loss_across_dp_ranks(loss, device):
    ...
    if pgm.process_group_manager.pp_is_last_stage:
        dist.all_reduce(
            reduced_loss, op=dist.ReduceOp.AVG, group=pgm.process_group_manager.dp_group
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pp_engine", type=str, default="afab", choices=["1f1b", "afab"]
    )
    ...
    setup_process_group_manager(
        dp_size=args.dp_size, pp_size=args.pp_size, tp_size=args.tp_size
    )
